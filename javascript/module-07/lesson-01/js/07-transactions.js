...
function createTableMarkup1(data = []) {
  return data
    .map(item => {
      return `
      <tr>
...
// console.time("Reduce");
// const tableMarkup = createTableMarkup(transactionHistory);
// console.timeEnd("Reduce");

// console.time("Map + Join");
// const tableMarkup1 = createTableMarkup1(transactionHistory);
// console.timeEnd("Map + Join");
